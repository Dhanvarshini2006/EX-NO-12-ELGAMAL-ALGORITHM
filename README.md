...
int main() {
    ...
    printf("Enter Dhanvarshini's private key: ");
    scanf("%lld", &privateKeyA);

    // Step 3: Compute Alice's public key (public_key = g^privateKeyA mod p)
    publicKeyA = modExp(g, privateKeyA, p);
    printf("Dhanvarshini's public key: %lld\n", publicKeyA);
...
<img width="716" height="488" alt="image" src="https://github.com/user-attachments/assets/5bea65ea-f5b4-4392-8c4a-14e4d6e7636a" />
